/*
문제1. 함수의 반환 타입만 추출하는 유틸리티 타입을 작성하세요.
요구사항:
...
/*
문제2. 동적으로 주어진 키를 사용해 객체의 값을 추출하는 함수를 작성하세요.
요구사항:
...
/*
문제3. API 요청에서 들어오는 데이터의 형식에 따라 처리 로직이 달라집니다. 요청 타입에 따라 처리할 수 있는 데이터의 타입을 결정하세요.
요구사항:
